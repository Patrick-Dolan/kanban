...
function SubtaskCheckbox({ task, checked, onClick }: SubtaskCheckboxProps) {
  return (
    <div 
      ...
      onClick={onClick}
    >
      <div className={`h-4 w-4 rounded-sm ${checked ? "bg-primary flex justify-center items-center" : "bg-white dark:bg-black-3 ring-1 ring-inset ring-gray ring-opacity-25"}`}>
